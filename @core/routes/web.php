...
Route::group(['middleware' => ['setlang', 'globalVariable', 'donation_module_check']], function () {
    ...
    Route::get('/donation-flutterwave/pay', 'FrontendController@flutterwave_pay_get')->name('frontend.donation.flutterwave.pay');
    Route::post('/donation-flutterwave/pay', 'DonationLogController@flutterwave_pay');
...
Route::group(['middleware' => ['setlang', 'globalVariable', 'product_module_check']], function () {
    ...
    Route::post('/product-flullterwave/pay', 'ProductOrderController@flutterwave_pay');
...
Route::group(['middleware' => ['setlang', 'globalVariable', 'event_module_check']], function () {
    ...
    Route::get('/event-flullterwave/pay', 'FrontendController@flutterwave_pay_get')->name('frontend.event.flutterwave.pay');
    Route::post('/event-flullterwave/pay', 'EventPaymentLogsController@flutterwave_pay');
...
Route::group(['middleware' => ['setlang', 'globalVariable', 'job_module_check']], function () {
    ...
    //job payment gateway
    Route::post('/job-paypal-ipn', 'JobPaymentController@paypal_ipn')->name('frontend.job.paypal.ipn');
    Route::post('/job-paytm-ipn', 'JobPaymentController@paytm_ipn')->name('frontend.job.paytm.ipn');
    Route::post('/job-stripe', 'JobPaymentController@stripe_ipn')->name('frontend.job.stripe.ipn');
...
Route::prefix('admin-home')->middleware(['products_manage_check', 'product_module_check'])->group(function () {
    ...
    Route::post('/products/order-reminder', 'ProductsController@order_reminder')->name('admin.product.order.reminder');
...
Route::prefix('admin-home')->middleware(['job_post_manage_check', 'job_module_check'])->group(function () {
    ...
    Route::post('/jobs/applicant/mail', 'JobsController@job_applicant_mail')->name('admin.jobs.applicant.mail');
    //job order success page
    Route::get('/jobs/success-page-settings', 'JobsController@success_page_settings')->name('admin.jobs.success.page.settings');
    Route::post('/jobs/success-page-settings', 'JobsController@update_success_page_settings');
    Route::get('/jobs/cancel-page-settings', 'JobsController@cancel_page_settings')->name('admin.jobs.cancel.page.settings');
    Route::post('/jobs/cancel-page-settings', 'JobsController@update_cancel_page_settings');
});
...
Route::prefix('admin-home')->middleware(['gallery_page_check'])->group(function () {
    ...
    Route::get('gallery-page/page-settings', 'ImageGalleryPageController@page_settings')->name('admin.gallery.page.settings');
    Route::post('gallery-page/page-settings', 'ImageGalleryPageController@update_page_settings');

    //category
    Route::get('/gallery-page/category', 'ImageGalleryPageController@category_index')->name('admin.gallery.category');
    Route::post('/gallery-page/category/new', 'ImageGalleryPageController@category_store')->name('admin.gallery.category.new');
    Route::post('gallery-page/category/update', 'ImageGalleryPageController@category_update')->name('admin.gallery.category.update');
    Route::post('gallery-page/category/delete/{id}', 'ImageGalleryPageController@category_delete')->name('admin.gallery.category.delete');
...
Route::prefix('admin-home')->middleware(['events_manage_check', 'event_module_check'])->group(function () {
    ...
    Route::post('/events/event-attendance/reminder', 'EventsController@event_attedance_reminder')->name('admin.event.attendance.reminder');
    //event payment logs
...
Route::prefix('admin-home')->middleware(['donations_manage_check', 'donation_module_check'])->group(function () {
    ...
    Route::post('/donations/reminder', 'DonationController@donation_reminder')->name('admin.donation.reminder');
