    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('Circular Sub Categories')}}</h4>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            @php $a=0; @endphp
                            @foreach($all_sub_category as $key => $slider)
                                <li class="nav-item">
                        ...
                        <div class="tab-content margin-top-40" id="myTabContent">
                            @php $b=0; @endphp
                            @foreach($all_sub_category as $key => $category)
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.circular.sub-category.new')}}" method="post"
                            ...
                            <div class="form-group">
                                <label for="status">{{__('Parent Categories')}}</label>
                                <select name="parent" class="form-control">
                                    @foreach($all_categories['en'] as $category)
    ...
    <div class="modal fade" id="image_category_item_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.circular.sub-category.update')}}" method="post" enctype="multipart/form-data">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#bulk_delete_btn', function (e) {
                ...
                if (allIds != '') {
                    ...
                    $.ajax({
                        'type': "POST",
                        'url': "{{route('admin.circular.category.bulk.action')}}",
                        'data': {
                            _token: "{{csrf_token()}}",
                            ids: allIds,
                            type: bulkOption
