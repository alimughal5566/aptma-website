...
{{--                                    href="{{route('admin.frontend.import.users.view')}}">{{__('Import User')}}</a></li>--}}
                    ...
                    @endif
                    @if(check_page_permission_by_string('All Payment Logs'))
                        <li class="main_dropdown {{active_menu('admin-home/payment-logs')}} {{active_menu('admin-home/payment-logs/report')}}">
                            <a href="javascript:void(0)"
                               aria-expanded="true">
                                <span>{{__('Package Payments')}}</span>
                            </a>
                            <ul class="collapse">
                    ...
                    <li class="main_dropdown {{active_menu('admin-home/topbar-settings')}}">
                    ...
                    <li class="main_dropdown @if(request()->is('admin-home/home-page-01/*')  ) active @endif
...
{{--                            @if(get_static_option('home_page_variant') == '03')--}}
                    ...
                    <li class="main_dropdown @if(request()->is('admin-home/feedback-page/*')  ) active @endif">
                        <a href="javascript:void(0)"
                           aria-expanded="true">
                            <i class="ti-home"></i>
                            <span>{{__('Feedback Page Manage')}}</span>
                        </a>
                        <ul class="collapse">
