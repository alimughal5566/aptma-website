    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-7 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('Advertisements')}}</h4>
                                        ...
                                        <table class="table table-default" id="all_blog_table">
                                            ...
                                            @foreach($all_gallery_images as $data)
                                                <tr>
                                                    ...
                                                    <td><a class="text-white" href="{{route('frontend.advertisement.single',$data->id)}}">{{$data->id}}</a></td>
                                                    ...
                                                    <td>
                                                        <a tabindex="0" class="btn btn-danger btn-xs mb-3 mr-1"
                                                           ...
                                                           title=""
                                                           data-content="
                                                           <h6>{{__('Are you sure to delete this advertisement ?')}}</h6>
                                                           <form method='post' action='{{route('admin.advertisement.delete',$data->id)}}'>
            ...
            <div class="col-lg-5 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.advertisement.new')}}" method="post" enctype="multipart/form-data">
                            @csrf
...
{{--                            </div>--}}
                            <div class="form-group">
                                <label class="mb-0" for="image">{{__('Image')}}</label>
    ...
    <div class="modal fade" id="testimonial_item_edit_modal" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{route('admin.advertisement.update')}}" id="testimonial_edit_modal_form"  method="post" enctype="multipart/form-data">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "{{route('admin.advertisement.bulk.action')}}",
                        'data' : {
                            _token: "{{csrf_token()}}",
                            ids: allIds
                        },
            ...
            $(document).on('change','select[name="lang"]',function (e) {
                ...
                $.ajax({
                    url : "{{route('admin.advertisement.category.by.lang')}}",
                    type: "POST",
                    data: {
                        _token : "{{csrf_token()}}",
                        lang: selectedLang
