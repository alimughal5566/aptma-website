            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.advertisement.category.new')}}" method="post" enctype="multipart/form-data">
                            @csrf
    ...
    <div class="modal fade" id="image_category_item_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.advertisement.category.update')}}" method="post" enctype="multipart/form-data">
