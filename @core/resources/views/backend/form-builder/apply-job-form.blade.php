    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__("Apply Job Form Builder")}}</h4>
                        <form action="{{route('admin.form.builder.apply.job.form')}}" method="Post">
                            <div class="alert alert-warning">
                                {{__('name, email filed will be added automatically')}}
                            </div>
                            @csrf
                            {!! render_drag_drop_form_builder_markup(get_static_option('apply_job_page_form_fields')) !!}
