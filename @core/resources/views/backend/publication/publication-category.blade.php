                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a tabindex="0" class="btn btn-lg btn-danger btn-sm mb-3 mr-1"
                                                           ...
                                                           <form method='post' action='{{route('admin.publication.category.delete',$data->id)}}'>
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.publication.category.new')}}" method="post" enctype="multipart/form-data">
                            @csrf
    ...
    <div class="modal fade" id="image_category_item_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.publication.category.update')}}" method="post" enctype="multipart/form-data">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != ''){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "{{route('admin.publication.category.bulk.action')}}",
                        'data' : {
                            _token: "{{csrf_token()}}",
                            ids: allIds,
                            type: bulkOption
