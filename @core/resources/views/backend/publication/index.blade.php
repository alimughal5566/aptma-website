...
{{--                                                    </td>--}}
                                                    ...
                                                    <td>
                                                        <a tabindex="0" class="btn btn-danger btn-xs mb-3 mr-1"
                                                           ...
                                                           <form method='post' action='{{route('admin.publication.delete',$data->id)}}'>
            ...
            <div class="col-lg-5 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.publication.new')}}" method="post" enctype="multipart/form-data">
                            @csrf
    ...
    <div class="modal fade" id="testimonial_item_edit_modal" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{route('admin.publication.update')}}" id="testimonial_edit_modal_form"  method="post" enctype="multipart/form-data">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "{{route('admin.publication.bulk.action')}}",
                        'data' : {
                            _token: "{{csrf_token()}}",
                            ids: allIds
                        },
