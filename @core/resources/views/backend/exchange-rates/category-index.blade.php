...
{{--                                                           <form method='post' action='{{route('admin.exchnage.category.delete',$data->id)}}'>--}}
    ...
    <div class="modal fade" id="image_category_item_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.exchnage.category.update')}}" method="post" enctype="multipart/form-data">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != ''){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "{{route('admin.exchnage.category.bulk.action')}}",
                        'data' : {
                            _token: "{{csrf_token()}}",
                            ids: allIds,
                            type: bulkOption
