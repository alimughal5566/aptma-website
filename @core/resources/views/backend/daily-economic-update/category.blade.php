    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('Daily Economics Categories')}}</h4>
                                            ...
                                            @foreach($category as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        {{--                                                           <form method='post' action='{{route('admin.daily.economic.update.category.delete',$data->id)}}'>--}}
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.daily.economic.update.category.new')}}" method="post"
    ...
    <div class="modal fade" id="image_category_item_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.daily.economic.update.category.update')}}" method="post" enctype="multipart/form-data">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#bulk_delete_btn', function (e) {
                ...
                if (allIds != '') {
                    ...
                    $.ajax({
                        'type': "POST",
                        'url': "{{route('admin.daily.economic.update.category.bulk.action')}}",
                        'data': {
                            _token: "{{csrf_token()}}",
                            ids: allIds,
                            type: bulkOption
