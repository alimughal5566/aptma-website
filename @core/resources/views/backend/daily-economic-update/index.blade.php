    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-7 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('Daily Economics')}}</h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a tabindex="0" class="btn btn-danger btn-xs mb-3 mr-1"
                                                       ...
                                                       title=""
                                                       data-content="
                                                           <h6>{{__('Are you sure to delete this data ?')}}</h6>
                                                           <form method='post' action='{{route('admin.daily.economic.update.delete',$data->id)}}'>
            ...
            <div class="col-lg-5 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.daily.economic.update.new')}}" method="post" enctype="multipart/form-data">
                            @csrf
    ...
    <div class="modal fade" id="testimonial_item_edit_modal" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{route('admin.daily.economic.update.update')}}" id="testimonial_edit_modal_form" method="post"
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#bulk_delete_btn', function (e) {
                ...
                if (allIds != '' && bulkOption == 'delete') {
                    ...
                    $.ajax({
                        'type': "POST",
                        'url': "{{route('admin.daily.economic.update.bulk.action')}}",
                        'data': {
                            _token: "{{csrf_token()}}",
                            ids: allIds
                        },
            ...
            $(document).on('change', 'select[name="lang"]', function (e) {
                ...
                $.ajax({
                    url: "{{route('admin.daily.economic.update.category.by.lang')}}",
                    type: "POST",
                    data: {
                        _token: "{{csrf_token()}}",
                        lang: selectedLang
