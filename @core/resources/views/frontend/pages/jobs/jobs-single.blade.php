                        ...
                        <div class="apply-procedure">
                            ...
                            @else
                                @if(!empty(get_static_option('job_single_page_apply_form')))
                                    <a class="btn-boxed style-01 margin-top-30"
                                       href="{{route('frontend.jobs.apply',$job->id)}}">{{get_static_option('job_single_page_'.$user_select_lang_slug.'_apply_button_text')}}</a>
                                @else
                                    <p>{{get_static_option('job_single_page_'.$user_select_lang_slug.'_apply_button_text')}}
                                        : <span>{{$job->email}}</span></p>
                                @endif
                            @endif
                        </div>
                    </div>
