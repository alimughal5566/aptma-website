...
@section('content')
    ...
    <div class="page-content service-details common-single economic-single padding-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="economic-single-title-wrap d-flex align-items-center justify-content-between mb-3">
