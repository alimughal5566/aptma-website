                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-what-we-cover-item-02 margin-bottom-30">
                            ...
                            <div class="content">
                               ...
                               <p>Last updated: {{@$data->updated_at->format('dMY')}}</p>
                               <a href="{{route('frontend.circular.single',$data->id)}}" target="_blank"><h4 class="title">{{$data->title}}</h4></a>
                                @php
                                ...
                                @endif
                                <a href="{{asset('assets/uploads/circular/'.$data->url)}}" class="float-right text-right pr-1" download>download</a>
                            </div>
                        </div>
                    </div>
                    @php
