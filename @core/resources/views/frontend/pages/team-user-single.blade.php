            ...
            <div class="row ">
                ...
                <div class="col-lg-6 ">
                    <div class="service-details-item common-single-item team-single-item position-relative">
                        ...
                        <h6 class="team-date font-weight-bold"></h6>
                        <div class="service-description team-about">About me: {!! $data->about_me !!}</div>
                        <div class="service-description team-description">Description: {!! $data->description !!}
