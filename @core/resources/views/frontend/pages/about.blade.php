...
@section('content')
    @if(!empty(get_static_option('about_page_about_us_section_status')))
        <section class="top-experience-area padding-top-40 padding-bottom-40">
                        ...
                        <div class="global-content">
                            ...
                            @if(!empty(get_static_option('about_page_'.$user_select_lang_slug.'_global_network_button_status')))
                                <div class="btn-wrapper padding-top-25">
                                    <a href="{{get_static_option('about_page_'.$user_select_lang_slug.'_global_network_button_url')}}"
                                       class="boxed-btn reverse-color">{{get_static_option('about_page_'.$user_select_lang_slug.'_global_network_button_title')}}</a>
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        >
                            <div class="vdo-btn">
                                <a class="video-play-btn mfp-iframe"
                                   href="{{get_static_option('about_page_'.$user_select_lang_slug.'_experience_video_url')}}"><i
