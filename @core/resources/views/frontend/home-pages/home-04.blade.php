        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="experience-author bg-image"
                   {!! render_background_image_markup_by_attachment_id(get_static_option('home_page_04_quality_area_image')) !!}
                >
                </div>
            </div>
            <div class="col-lg-5 offset-lg-1 p-0">
                <div class="experience-content-03 section-padding">
                    <div class="content">
                        <h2 class="title">{{get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_title')}}</h2>
                        <p>{!! get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_description') !!}</p>
                        <div class="servicee-area">
                            <ul>
                                @php
                                $bullet_list = explode("\n",get_static_option('home_page_01_en_quality_area_list'));
                                @endphp
