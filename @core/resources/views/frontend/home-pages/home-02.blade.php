                            ...
                            @if(!empty($data->btn_01_status))
                                <div class="btn-wrapper  desktop-left padding-top-30">
                                    <a href="{{$data->btn_01_url}}"
                                       class="boxed-btn reverse-color ">{{$data->btn_01_text}}</a>
                                </div>
                            @endif
                        </div>
                    </div>
    ...
    <div class="global-network-area bg-liteblue padding-bottom-120 padding-top-120">
        <div class="container">
            <div class="row">
                        ...
                        @if(!empty(get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_button_status')))
                            <div class="btn-wrapper padding-top-25">
                                <a href="{{get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_button_url')}}"
                                   class="boxed-btn reverse-color">{{get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_button_title')}}</a>
                            </div>
                        @endif
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="map-img">
                        {!! render_image_markup_by_attachment_id(get_static_option('home_page_02_quality_area_image')) !!}
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row no-gutters">
                <div class="col-lg-6">
                    <div class="experience-right style-01"
                            {!! render_background_image_markup_by_attachment_id(get_static_option('home_page_02_about_us_video_background_image')) !!}
                    >
                        <div class="vdo-btn">
                    ...
                    <div class="experience-content-02">
                        ...
                        <div class="sign-area">
                            ...
                            <div class="sing-img padding-top-10">
                                {!! render_image_markup_by_attachment_id(get_static_option('home_page_02_about_us_signature_image')) !!}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title desktop-center padding-bottom-25">
                        <h3>
                            {{get_static_option('home_page_01_'.$user_select_lang_slug.'_brand_logo_area_title')}}
                        </h3>
                    </div>
                </div>
            </div>
...
@if(!empty(get_static_option('home_page_case_study_section_status')))
    <div class="case-studies-area-02 bg-image padding-bottom-120" {!! render_background_image_markup_by_attachment_id(get_static_option('home_page_02_case_study_background_image')) !!}>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="section-title desktop-center padding-bottom-55">
                        <h3 class="title">{{get_static_option('home_page_01_'.$user_select_lang_slug.'_team_member_section_title')}}</h3>
