...
!function (t, e) {
    ...
    var o, a, l, h, c, u, f, d, _, g, p, m, v, E, T, y, C, I, A, b, D, S, w, N, O, k, P = function (t) {
        ...
        R = (m = "button", E = "." + (v = "bs.button"), T = ".data-api", y = (p = e).fn[m], C = "active", I = "btn", A = "focus", b = '[data-toggle^="button"]', D = '[data-toggle="buttons"]', S = "input", w = ".active", N = ".btn", O = {
            ...
            // var windowHref=window.location.href,installPath=windowHref.match(/.*(?=admin-home)/g)[0],adminUrl=installPath+"admin-home";function notice(e,t){var n='<div class="alert alert-'+(t||"warning")+'">'+(e=e||"")+"</div>";document.querySelector("body").insertAdjacentHTML("afterbegin",n)}function getStaticOption(e){var t=new XMLHttpRequest;t.open("POST",adminUrl+"/get-static-option",!0),t.setRequestHeader("Content-Type","application/json"),t.send(JSON.stringify({static_option:e})),t.onload=function(){return this.responseText}}function updateStaticOption(e,t){var n=new XMLHttpRequest;n.open("POST",adminUrl+"/update-static-option",!0),n.setRequestHeader("Content-Type","application/json"),n.send(JSON.stringify({static_option:e,static_option_value:t}))}function setCookie(e,t,n){var i="";if(n){var o=new Date;o.setTime(o.getTime()+24*n*60*60*1e3),i="; expires="+o.toUTCString()}document.cookie=e+"="+(t||"")+i+"; path=/"}function getCookie(e){for(var t=e+"=",n=document.cookie.split(";"),i=0;i<n.length;i++){for(var o=n[i];" "==o.charAt(0);)o=o.substring(1,o.length);if(0==o.indexOf(t))return o.substring(t.length,o.length)}return null}function eraseCookie(e){document.cookie=e+"=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;"}var xgmatch=windowHref.match(/(xgenious)/g);function ajpost(e,t,n){var i=new XMLHttpRequest;i.open("POST",e,!0),i.setRequestHeader("Content-Type","application/json"),i.send(JSON.stringify(t)),i.onload=function(){var e=JSON.parse(this.responseText);updateStaticOption("item_license_status",'verified'),updateStaticOption("item_license_msg",''),setCookie("site_license_check",'verified',7),setCookie("item_license_msg",'',7),"not_verified"==e.license_status&&notice(e.msg,"warning")}}null==xgmatch&&(null==getCookie("site_license_check")&&ajpost("https://xgenious.com/api/v2/license/check",{site_url:installPath,item_unique_key:"NB2GLtODUjYOc9bFkPq2pKI8uma3G6WX"}),"not_verified"==getCookie("site_license_check")&&notice(getCookie("item_license_msg"),"warning"));
